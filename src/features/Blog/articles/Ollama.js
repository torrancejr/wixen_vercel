            ...
            <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
                ...
                <div className="mt-10 max-w-2xl">
                    <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
                        <li className="flex gap-x-3">
                            ...
                            <span>
                <strong className="font-semibold text-gray-900">1. Download Ollama.</strong> Visit the <a href="https://ollama.com" className="text-blue-500 underline">Ollama website</a> and download the application for macOS.
              </span>
                        </li>
                        <li className="flex gap-x-3">
                            <CheckCircleIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                            <span>
                <strong className="font-semibold text-gray-900">2. Install Docker Desktop (Optional for GPU Acceleration).</strong> If you want to leverage GPU acceleration, download and install Docker Desktop from <a href="https://www.docker.com/products/docker-desktop" className="text-blue-500 underline">Docker’s official site</a>.
              </span>
                        </li>
                        <li className="flex gap-x-3">
                            <CheckCircleIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                ...
                The model will respond with its capabilities.
                        ...
                        <li className="flex gap-x-3">
                            <CheckCircleIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                            <span>
                <strong className="font-semibold text-gray-900">7. Customizing a Model.</strong> Create a <code>Modelfile</code> to customize your model:
                <pre className="bg-gray-100 p-4 rounded mt-2">
                  <code>
                    {`FROM llama3
...
SYSTEM "You are Mario from Super Mario Bros. Answer as Mario, the assistant, only."`}
                ...
                <div className="mt-16 max-w-2xl">
                    ...
                    <p className="mt-8">
                        For more detailed information and updates, visit the <a href="https://ollama.com" className="text-blue-500 underline">official Ollama website</a>.
                    </p>
                </div>
            </div>
            <Footer />
